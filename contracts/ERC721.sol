...
contract ERC721 {
    ...
    function isApprovedForAll(address owoner, address operator)
        public
        view
        returns (bool)
    {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            msg.sender == owoner || isApprovedForAll(owoner, msg.sender),
            "msg.sender is not owoner or approved oparetor"
        );
    ...
    function transferFrom(
        ...
        require(from == owoner, "invalid owenr of the NFT");

        require(to == address(0), "invalid address to transfar the NFT");

        require(_owoners[tokenId] != address(0), "tokenId is not a valid NFT");
    ...
    // Standard transfarFrom
    // Check if onERC721Receved is implemented WHEN sending to smart contracts
    function safeTransferFrom(
        ...
        require(_checkOnERC721Receved(), "recever not implemented");
    }
    ...
    function _checkOnERC721Receved() private pure returns (bool) {
        return true;
    }
